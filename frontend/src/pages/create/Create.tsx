...
type Values = { name: string; description: string; waterFlow: number; ph: number; residence: string };

const defaultValues = { name: '', description: '', waterFlow: 0, ph: 0, residence: '' };
    ...
    <>
      ...
      <div className={styles.main}>
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={styles.item}>
            <Input label="Description" className={styles.input} {...register('description', { required: 'Description is required' })} />
